...
export default function Home() {
  ...
  return (
    ...
    <main>
      <section id="hero" className="px-8 sm:px-12 lg:px-20 py-6">
        <div className="flex flex-col gap-4">
            ...
            <p className="text-lg">
              ...
              <br />Yuk langsung join di Mabarin!
            </p>
            <div className="w-fit px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-full transition-all duration-200 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40">
              <button className="text-white text-sm font-semibold">Start Exploring</button>
            </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="px-8 sm:px-12 lg:px-20 py-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 mt-2 text-lg">Tiga langkah mudah untuk mulai berolahraga bersama komunitas favoritmu.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Find Activity</h3>
            <p className="text-gray-500 leading-relaxed max-w-xs">
              Cari kategori dan aktivitas olahraga dan lokasi yang terdekat sesuai yang kamu inginkan.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Join & Play</h3>
            <p className="text-gray-500 leading-relaxed max-w-xs">
              Datang ke lokasi, tunjukkan tiket, dan nikmati keseruan mabar bersama teman-teman baru!
            </p>
          </div>
        </div>
      </section>
