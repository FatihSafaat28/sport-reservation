      ...
      <main>
        ...
        >
          ...
          <div className="flex flex-col gap-6 w-full justify-center relative z-10 max-w-[1440px] mx-auto">
            ...
            <div className="w-fit">
              <Link href="/explore" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white text-base font-semibold rounded-full transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transform hover:-translate-y-1">
                Start Exploring
              </Link>
            </div>
          </div>
